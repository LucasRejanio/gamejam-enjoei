...
function how_to.load()
    ...
    how_to.mouse_sprite = love.graphics.newImage("img/how_to/mouse.png")
...
function how_to.draw()
    ...
    spacebar_y = ((Game.height*Game.scale)/2.3)
    ...
    left_arrow_y = ((Game.height*Game.scale)/5.5)
    ...
    right_arrow_y = ((Game.height*Game.scale)/5.5)
    love.graphics.draw(how_to.right_arrow, right_arrow_x,right_arrow_y,0,arrow_scale,arrow_scale)

    --mouse sprite
    mouse_scale = 2
    mouse_x = ((Game.width*Game.scale)/1.9) - (how_to.spacebar_sprite:getWidth()*spacebar_scale/1.9)
    mouse_y = ((Game.height*Game.scale)/1.5)
    love.graphics.draw(how_to.mouse_sprite, mouse_x, mouse_y,0, mouse_scale, mouse_scale)
    ...
    spacebar_text_y = ((Game.height*Game.scale)/2.5) - how_to.spacebar_sprite:getHeight()*spacebar_scale

    --arrows text
    arrows_text = love.graphics.newText(love.graphics.newFont(30),"Use as setas do teclado para mudar de personagem")
    arrows_text_x = ((Game.width*Game.scale)/2) - (arrows_text:getWidth()/2)
    arrows_text_y = ((Game.height*Game.scale)/7) - how_to.left_arrow:getHeight()*arrow_scale
    ...
    mouse_text_y = ((Game.height*Game.scale)*3/5.2)

     --how_to text
     how_to_text = love.graphics.newText(love.graphics.newFont(30),"E lembre-se: não chegue perto dos bugs!")
     how_to_text_x = ((Game.width*Game.scale)/2) - (how_to_text:getWidth()/2)
     how_to_text_y = ((Game.height*Game.scale)*4/5.1)
